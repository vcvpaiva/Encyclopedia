...
\begin{history}
The purpose of this system is to provide  a
...
to the left-hand side relates to call-by-name evaluation, while giving priority to the right-hand side relates to call-by-value evaluation~\cite{CurienHerbelin00}. Thanks to the presence of two dual
axiom rules and implicit contraction rules, the system supports a
tree-like sequent-free presentation, as originally presented by
